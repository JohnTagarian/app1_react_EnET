...
export default function FormText() {
  ...
  const onBlurPassword = () => {
    ...
    if (pswd !== '' && !pswd.match(/^[0-9a-zA-Z]+$/)) {
      ...
      alert('รหัสผ่านต้องประกอบด้วยตัวอักษรภาษาอังกฤษและตัวเลขเท่านั้น')
    }
  }
  ...
  const onBlurPassword2 = () => {
    if (textPswd.current.value !== textPswd2.current.value) {
      ...
      alert('รหัสผ่านทั้งสองช่องไม่ ตรงกัน ')
    }
  }
  ...
  return (
    <div className="mt-4 mx-auto p-3 rounded"
      ...
      <form>
        ...
        <div className="form-group mb-2">
          <label htmlFor="pswd2" className="form-label">ยืนยันรหัสผ่าน</label>
        ...
        <div className="form-group mb-4">
          <label htmlFor="memo" className="form-label">บันทึกช่วยจำ</label>
